...
检查是否存在strings /usr/lib/x86_64-linux-gnu/libstdc++.so.6 | grep GLIBCXX，确实存在。

使用如下指令进行软连接解决`GLIBCXX_3.4.30' not found问题。

cd /home/my/anaconda3/envs/DAINet-jittor/bin/../lib/

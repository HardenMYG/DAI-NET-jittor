...
def load_models():
    ...
    net.eval()
    net.load('/home/my/JITTOR/DAI-NET-JITTOR/weights/dark/dsfd.pth') # Set the dir of your model weight
...
if __name__ == '__main__':
    ...
    def load_images():
      imglist = glob.glob('/home/my/JITTOR/DAI-NET-JITTOR/58.png') # Set the dir of your test data
      return imglist
    ...
    now = 0
    print('Processing: {}/{}'.format(now+1, len(img_list)))
